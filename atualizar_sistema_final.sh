...
echo "ATUALIZANDO SISTEMA MONPEC PROJETISTA"
echo "====================================="
    ...
    if request.method == 'POST':
        try:
            ...
            if not nome or not cpf:
                messages.error(request, 'Nome e CPF sao obrigatorios!')
            ...
            messages.success(request, f'Proprietario {nome} cadastrado com sucesso!')
