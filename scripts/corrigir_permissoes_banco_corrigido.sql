-- Script CORRIGIDO para permissões do usuário monpec_user no PostgreSQL
...
-- Configurar permissões padrão para NOVAS tabelas/sequences/functions
...
-- Conceder permissões em tabelas existentes (ignora erros se já tiver)
