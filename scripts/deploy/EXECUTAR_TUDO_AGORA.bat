...
REM Navegar para o diretório raiz do projeto (dois níveis acima de scripts/deploy)
cd /d "%~dp0\..\.."
...
powershell -ExecutionPolicy Bypass -File "%~dp0\DEPLOY_GOOGLE_CLOUD_COMPLETO_AUTOMATICO.ps1"
