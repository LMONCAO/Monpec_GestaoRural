#!/bin/bash
# Script completo de deploy para Cloud Shell
# Repositório: https://github.com/LMONCAO/Monpec_GestaoRural

set -e

echo "🚀 MONPEC - Deploy Completo no Google Cloud Run"
echo "========================================"
echo ""
...
GITHUB_REPO="https://github.com/LMONCAO/Monpec_GestaoRural.git"
...
echo ""
echo "📥 Clonando/Atualizando repositório do GitHub..."
...
if grep -q "^django-logging==0.1.0" requirements_producao.txt 2>/dev/null; then
    echo "⚠️  django-logging ainda encontrado! Corrigindo..."
    ...
    echo "✅ django-logging não encontrado (correto!)"
fi

# Verificar Dockerfile
if grep -q "pip install --no-cache-dir gunicorn$" Dockerfile 2>/dev/null; then
    echo "⚠️  Dockerfile tem linha redundante. Corrigindo..."
...
echo ""
echo "📖 Para configurar domínio monpec.com.br:"
