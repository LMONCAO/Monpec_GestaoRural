# -*- coding: utf-8 -*-
"""
Script para criar transferências do Favo de Mel para Girassol em 2024 e 2025
(350 cabeças a cada 3 meses, respeitando o saldo disponível)
"""
import os
import sys
import django
...
@transaction.atomic
def criar_transferencias_favo_girassol_2024_2025():
    """Cria transferências do Favo de Mel para Girassol em 2024 e 2025"""
    
    print("=" * 80)
    print("CRIAR TRANSFERENCIAS FAVO DE MEL -> GIRASSOL 2024 E 2025")
    print("=" * 80)
...
if __name__ == '__main__':
    ...
    try:
        criar_transferencias_favo_girassol_2024_2025()
