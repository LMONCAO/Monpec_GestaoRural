...
echo "============================================================"
echo "🔍 Verificando se tabela UsuarioAtivo existe..."
echo "============================================================"
echo ""
